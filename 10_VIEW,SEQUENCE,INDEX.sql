...
INCREMENT BY 5 -- NEXTVAL호출시 5씩 증가 감소는 -5
MAXVALUE 150   -- 장가 가능한 최대값 150
NOMINVALUE		 -- 최소값 없음
NOCYCLE				 -- 반복 안함
...
-- EMPLOYEE 테이블의 ENP_NAME 컬럼에 대해 빠른 검색이 가능
