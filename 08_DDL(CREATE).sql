...
--> 전화번호, 주민등록 번호 처럼 숫자로만 되어있는 데이터라도
-- 0으로 시작될 가능성이 있으면 CHAR, VARCHAR2 같은 문자열 타입으로 사용
...
CREATE TABLE USER_USED_FK (
	...
	REFERENCES USER_GRADE /*(GRADE_CODE)*/ -- 컬럼레벨
												-- 컬럼명 미작성시 USER_GRADE 테이블의 PK를 자동참조함
	-- 테이블 레벨
...
1, 'USER01', 'PASS01', '홍길동', '남자', 
'010-1234-3333', 'hong_gd@or.kr', 10);
-- USER_GRADE(부모/참조테이블)에 10이라는 
-- GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK VALUES (
2, 'USER02', 'PASS02', '이순신', '남자', 
'010-5555-3333', 'lee_gd@or.kr', 10);
-- USER_GRADE(부모/참조테이블)에 10이라는 
-- GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK VALUES (
3, 'USER03', 'PASS03', '유관순', '여자', 
'010-6666-3333', 'yoo_ks@or.kr', 30);
-- USER_GRADE(부모/참조테이블)에 30이라는 
-- GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK VALUES (
4, 'USER04', 'PASS04', '안중근', '남자', 
'010-6666-5555', 'ahn_jk@or.kr', NULL);
--> NULL 사용 가능

INSERT INTO USER_USED_FK VALUES (
5, 'USER05', 'PASS05', '윤봉길', '남자', 
'010-7777-5555', 'ahn_jk@or.kr', 50);
...
-- GRADE CODE 중 20은 사용되지 않고 있으므로 삭제가 가능하다.
