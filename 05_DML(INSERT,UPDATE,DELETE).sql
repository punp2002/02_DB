...
-- 윈도우 > 설정 > 연결 > 연결유형 AUTO COMMIT 체크 해제

-- 테스트용 테이블 생성
CREATE TABLE EMPLOYEE2 AS SELECT * FROM EMPLOYEE;
CREATE TABLE DEPARTMENT2 AS SELECT * FROM DEPARTMENT;
-- DDL 바로저장
-- DML 과 DDL을 썩어서 쓰지 말것
-- DDL 후 DML 수행
...
SELECT * FROM EMPLOYEE2
WHERE EMP_ID = '900';
-- 조회 다시 해봄 (영구저장 되었기 때문에 롤백해도 되돌리기 안됨)

--------------------------------------------------------------

-- INSERT 시 VALUES 대신 서브쿼르 이용하여 삽입하기
...
-- * 여러 컬럼을 한번에 수정할 시 콤마(,)로 컬럼을 구문하면 됨.
-- D9 / 총무부 --> D0 / 전략기획팀 변경

UPDATE DEPARTMENT2
SET DEPT_ID = 'D0',
DEPT_TITLE = '전략기획팀' -- WHERE 직전 컬럼 , 하면 안됨
WHERE DEPT_ID = 'D9'
AND DEPT_TITLE = '총무부';
...
-- 이를 반영하는 UPDATE 문을 서브쿼리 이용하여 작성.
